...
static void fr10delay(void *ctx)
{
...
static void fr12delay(void *ctx)
{
    route_request(21);          // East departure
}
...
// ROUTE 13: G to C
static void rt13delay(void *ctx)
{
    if (rand() & 1)
...
// ROUTE 16: H to C
static void rt16delay(void *ctx)
{
    if (rand() & 1)
...
static void fr45delay(void *ctx)
{
    if (rand() & 1)
